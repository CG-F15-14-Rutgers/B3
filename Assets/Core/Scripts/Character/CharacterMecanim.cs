...
public class CharacterMecanim : MonoBehaviour
{
	...
	#region Lying Commands
	/// <summary>
	/// Sits the character down
	/// </summary>
	public virtual RunStatus LyingDown()
	{
		if (this.Body.IsLying() == true)
			return RunStatus.Success;
		this.Body.LyingDown();
		return RunStatus.Running;
	}
	...
	/// Stands the character up
	/// </summary>
	public virtual RunStatus StandUp_Sleep()
	{
		if (this.Body.IsStanding_Sleep() == true)
			return RunStatus.Success;
		this.Body.StandUp_Sleep();
		return RunStatus.Running;
	}
	#endregion
}
