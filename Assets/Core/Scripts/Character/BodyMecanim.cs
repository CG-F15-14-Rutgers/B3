...
public class BodyMecanim : MonoBehaviour
{
	...
	public void BodyAnimation(string gestureName, bool isActive)
	{
		...
		case "BREAKDANCE": 
			...
			break;
		case "GANASTYLE": 
			this.animator.SetBool("B_GanaStyle", isActive); 
			break;
		case "FIGHT": 
        ...
        case "DUCK":
            ...
            break;
		case "TALKINGONE":
			this.animator.SetBool("B_Talkingone", isActive);
			break;
		case "TALKINGTWO":
			this.animator.SetBool("B_Talkingtwo", isActive);
			break;
		case "ATTACK":
			this.animator.SetBool("B_Attack", isActive);
			break;
		case "HIT":
			this.animator.SetBool("B_Hit", isActive);
			break;
	...
	{
		this.animator.SetBool ("B_Sleeping", true);
	}
	...
	public void StandUp_Sleep()
	{
		this.animator.SetBool ("B_Sleeping", false);
	...
	public bool IsLying()
	{
		return this.animator.GetBool ("B_Sleeping");
	}
